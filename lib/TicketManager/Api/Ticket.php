...
class TicketManager_Api_Ticket extends Zikula_AbstractApi
{
	 ...
	 * @param string $args['logo'] A path to a small logo to print in each page header. (optional, default TicketManager logo).
	 * @param string $args['headerText'] A short text to write into each pages header (optional, default "Generated by TicketManager (c) Christian Flach")
	...
	public function reserve($args)
	{
		...
		if(!isset($headerText))
			$headerText = "Generated by TicketManager (c) Christian Flach";
